...
public class GraphQLConfiguration {
	...
	private static String[] SCHEMA_FILES = new String[] { "schema/root.graphql", "schema/customer.graphql",
			"schema/account.graphql", "schema/device.graphql" };
	...
	private RuntimeWiring buildWiring() {
		return RuntimeWiring.newRuntimeWiring()
				.type("Query",
						typeWiring -> typeWiring.dataFetcher("customer", rootDataFetcher.getCustomerDataFetcher())
								.dataFetcher("account", rootDataFetcher.getAccountDataFetcher())
								.dataFetcher("device", rootDataFetcher.getDeviceDataFetcher()))
				.type("Account",
						typeWiring -> typeWiring.dataFetcher("customer", rootDataFetcher.getAccountCustomerDataFetcher()))
				.type("Account", typeWiring -> typeWiring.dataFetcher("device", rootDataFetcher.getAccountDeviceDataFetcher()))
				.build();
	}
